...
<html>
	...
	<body bgcolor="#3b3e46" marginheight="0" marginwidth="0" style="font-family:Tahoma, Geneva, sans-serif; margin-top:0px; margin:0px;">
    
   		<div id="header_div">
    		<div id="menu_div">
        		<img src="images/header.jpg" alt="logo" width="370" height="200">
       			<ul>
           	  	  <li><a href="index.php" class="active">Vizyonda</a></li>
			  ...
			  if($film_durum == "vizyonda"){
     			echo   "<div id=\"vizyonda\">
					...
					<div id=\"vizyonda_detay\">
						...
						<detay1><br><detay2>Puan</detay2><detay21>:</detay21><detay3>&nbsp;{$film_puan}</detay3></detay1>
